...
HD_PWD='C:/Users/Jassh/vivado_proj/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_kill_boolean.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_kill_boolean.tcl
