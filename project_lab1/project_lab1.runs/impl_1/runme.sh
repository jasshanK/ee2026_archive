...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab1/project_lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log password.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source password.tcl -notrace
