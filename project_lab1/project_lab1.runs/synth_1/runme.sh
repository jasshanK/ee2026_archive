...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab1/project_lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log password.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source password.tcl
