...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab4/project_lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_output.tcl
