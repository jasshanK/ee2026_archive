...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab4/project_lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_output.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_output.tcl -notrace
