...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab3/project_lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_blinker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dynamic_blinker.tcl -notrace
