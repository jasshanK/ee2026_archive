...
HD_PWD='C:/Users/Jassh/vivado_proj/project_lab3/project_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamic_blinker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dynamic_blinker.tcl
