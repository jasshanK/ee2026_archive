...
HD_PWD='C:/Users/Jassh/vivado_proj/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_boolean.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_boolean.tcl -notrace
