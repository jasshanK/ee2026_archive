...
HD_PWD='C:/Users/Jassh/vivado_proj/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_boolean.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_boolean.tcl
