...
HD_PWD='C:/Users/Jassh/vivado_proj/project_assignment4/project_assignment4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fingerprint_scan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fingerprint_scan.tcl
