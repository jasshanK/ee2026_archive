...
HD_PWD='C:/Users/Jassh/vivado_proj/project_assignment4/project_assignment4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fingerprint_scan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fingerprint_scan.tcl -notrace
