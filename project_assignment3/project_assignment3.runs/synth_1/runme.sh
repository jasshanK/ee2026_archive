...
HD_PWD='C:/Users/Jassh/vivado_proj/project_assignment3/project_assignment3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log water_fill.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source water_fill.tcl
