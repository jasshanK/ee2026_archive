...
HD_PWD='C:/Users/Jassh/vivado_proj/project_assignment3/project_assignment3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log water_fill.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source water_fill.tcl -notrace
